# Door interaction design note — SUPERSEDED
...
should run `git rm phase2_notes/door_interaction.md`.** Every code comment
that used to cite this file by name has already been repointed at the
archive above.
