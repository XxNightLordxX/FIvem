...
(function () {
    ...
    var DEFAULT_STRINGS = {
        ...
        help_start_high_command_1: "1. Open the Command Console tab first. Find the person you need -- by roster search, by exact citizen ID for someone never certified before, or from the online players list -- and their whole record opens on one screen: certifications, role, XP, access and abilities, in the order you normally work down them.",
        help_start_high_command_2: "2. When someone needs to be set up as a new handler, open them from the Command Console and work down that one screen: certify them, set a tier, then grant feature access. Everything for that person is in one place, so there is nothing to hunt across.",
        ...
        help_tab_flows_desc: "A guided, step-by-step pass over the server-wide settings: which features are on, their tunable values, certification tiers, XP ranks and what the supply shop sells. Open it instead of the individual screens below when you want to walk the whole job in order rather than visiting three tabs.",
        ...
        help_task_hc_toggle_feature_3: "3. Prefer to be walked through it alongside every other server-wide setting? Open the Server Tuning tab, which steps through feature toggles, tunables, certification tiers, XP ranks and shop items in order.",
