--[[
    ...
    "SOURCE-ORIGIN GUARD" comment and phase2_notes/RESEARCH_ARCHIVE.md#trust-boundary).
    ...
    since-forged local trigger -- phase2_notes/RESEARCH_ARCHIVE.md#trust-boundary
...
-- earlier genuine server event -- phase2_notes/RESEARCH_ARCHIVE.md#trust-boundary
